...
Pentester Name
(Cybersecurity Professional)	Oboth Richard

Program/Batch	B082-Networkwalks

Date	16 September 2026

Modules completed	PM1 (Multiple Kali Tools)
...
I have performed these activities only on the systems & devices that I own myself. All these materials are for education and research purpose only. Do not use anything from here to break the law. The instructor, the authors and Networkwalks are not responsible for what you do with this knowledge. Every action you take is your own responsibility. Misuse can lead to criminal charges, heavy fines, loss of your job and a permanent record. In most countries unauthorised access is a crime even when nothing is damaged.
...
i. Tools used in the project and their purpose.

ii. Kali Linux & Windows	Operating systems used for reconnaissance activities

iii. WHOIS	Find domain registration details (owner, dates, name servers).

iv. whatweb	Fingerprint web technologies (server, CMS, plugins, IP).

v. nslookup	Resolve the domain name to its IP address using DNS.

vi. curl -I	Read the HTTP response headers of the website.

vii. wafw00f	Detect whether a Web Application Firewall protects the site.

viii. dnsrecon	Enumerate all DNS records (NS, MX, SPF, TXT, SRV).

ix. Zenmap (Nmap GUI)	Scan the local subnet to find live hosts, IPs and MAC addresses.

x. Windows CMD	Local IP and MAC address identification
...
The example results provided in the practical identified seven live hosts:
